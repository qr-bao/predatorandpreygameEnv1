...
class LISPredatorPreyEnv(gym.Env):
    ...
    def _initialize_agent_environment(self):
        ...
        self.initialnames = [agent.name for agent in self.simulator.preys + self.simulator.predators]
    ...
    def _initialize_spaces(self):
        ...
        ob_env1_space = gym.spaces.Tuple((
        ...
        ob_env1_space = gym.spaces.Tuple([ob_env1_space] * 20)
    ...
    def step(self, actions):
        ...
        return new_state, sum(rewards.values()), terminated, truncated, {}
